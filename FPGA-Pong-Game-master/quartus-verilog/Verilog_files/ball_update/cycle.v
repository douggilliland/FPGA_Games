...
//  Generated date: Thu May 14 15:23:45 2015
// ----------------------------------------------------------------------
...
module ball_update_core (
  ...
  begin : core
    ...
    reg and_18_itm_1;
    reg or_4_itm_1;
    reg if_25_slc_counter_itm_1;
    reg if_25_slc_counter_1_itm_1;
    reg if_25_slc_counter_2_itm_1;
    reg if_25_slc_counter_3_itm_1;
    reg if_25_slc_counter_4_itm_1;
        ...
        begin : mainExit
          forever begin : main
            ...
            if ( main_stage_0_2 ) begin
              ...
              state_sva_13 = 3'b0;
              state_sva_11 = 3'b0;
              state_sva_dfm_10 = MUX1HOT_v_3_3_2({3'b100 , 3'b11 , state_sva_dfm_15},
              ...
              state_sva_dfm_12 = MUX1HOT_v_3_3_2({state_sva_dfm_10 , state_sva_11
                  , 3'b1}, {(~ slc_3_svs_1) , ((~ (state_sva_dfm_10[2])) & slc_3_svs_1)
                  , ((state_sva_dfm_10[2]) & slc_3_svs_1)});
              ...
              state_sva_dfm_14 = MUX1HOT_v_3_3_2({state_sva_13 , 3'b1 , state_sva_dfm_12},
                  {(~((state_sva_dfm_12[2]) | slc_4_svs_1)) , ((state_sva_dfm_12[2])
                  & (~ slc_4_svs_1)) , slc_4_svs_1});
              land_9_lpi_1_dfm = if_25_slc_counter_itm_1 & if_25_slc_counter_1_itm_1
                  & if_25_slc_counter_2_itm_1 & if_25_slc_counter_3_itm_1 & if_25_slc_counter_4_itm_1
                  & if_25_nor_1_itm_1 & (state_sva_dfm_14[0]) & (~((state_sva_dfm_14[2])
                  | (state_sva_dfm_14[1])));
              if ( land_9_lpi_1_dfm ) begin
                ball_x_sva_4 = ball_x_sva_dfm_7 + conv_u2u_3_10(k_lpi_1_dfm_3);
                ball_y_sva_4 = readslicef_11_10_1((({ball_y_sva_dfm_7 , 1'b1}) +
                    ({7'b1111111 , (~ k_lpi_1_dfm_3) , 1'b1})));
              end
              else begin
                else_24_if_nor_1_cse = ~((counter_sva[19]) | (counter_sva[17]) |
                    (counter_sva[16]) | (counter_sva[13]) | (counter_sva[12]) | (counter_sva[10])
                    | (counter_sva[9]) | (counter_sva[7]) | (counter_sva[6]) | (counter_sva[5])
                    | (counter_sva[4]) | (counter_sva[3]) | (counter_sva[2]) | (counter_sva[1])
                    | (counter_sva[0]));
                else_24_land_lpi_1_dfm = (counter_sva[18]) & (counter_sva[15]) &
                    (counter_sva[14]) & (counter_sva[11]) & (counter_sva[8]) & else_24_if_nor_1_cse
                    & (state_sva_dfm_14[1]) & (~((state_sva_dfm_14[2]) | (state_sva_dfm_14[0])));
                if ( else_24_land_lpi_1_dfm ) begin
                  ball_x_sva_5 = ball_x_sva_dfm_7 + conv_u2u_3_10(k_lpi_1_dfm_3);
                  ball_y_sva_5 = ball_y_sva_dfm_7 + conv_u2u_3_10(k_lpi_1_dfm_3);
                end
                else begin
                  ...
                  if ( else_24_else_land_lpi_1_dfm ) begin
                    ball_x_sva_6 = readslicef_11_10_1((({ball_x_sva_dfm_7 , 1'b1})
                        + ({7'b1111111 , (~ k_lpi_1_dfm_3) , 1'b1})));
                    ball_y_sva_6 = ball_y_sva_dfm_7 + conv_u2u_3_10(k_lpi_1_dfm_3);
                  end
                  else begin
                    ...
                    if ( else_24_else_else_land_lpi_1_dfm ) begin
                      ball_x_sva_7 = readslicef_11_10_1((({ball_x_sva_dfm_7 , 1'b1})
                          + ({7'b1111111 , (~ k_lpi_1_dfm_3) , 1'b1})));
                      ball_y_sva_7 = readslicef_11_10_1((({ball_y_sva_dfm_7 , 1'b1})
                          + ({7'b1111111 , (~ k_lpi_1_dfm_3) , 1'b1})));
                    end
              ...
              and_32_cse = (~(else_24_else_else_land_lpi_1_dfm | else_24_else_land_lpi_1_dfm))
                  & nor_9_m1c;
              ball_x_sva_dfm_6 = MUX1HOT_v_10_5_2({ball_x_sva_4 , ball_x_sva_5 ,
                  ball_x_sva_6 , ball_x_sva_7 , ball_x_sva_dfm_7}, {land_9_lpi_1_dfm
                  , and_4_cse , and_31_cse , else_24_else_and_cse , and_32_cse});
              ball_y_sva_dfm_6 = MUX1HOT_v_10_5_2({ball_y_sva_4 , ball_y_sva_5 ,
                  ball_y_sva_6 , ball_y_sva_7 , ball_y_sva_dfm_7}, {land_9_lpi_1_dfm
                  , and_4_cse , and_31_cse , else_24_else_and_cse , and_32_cse});
              video_out_rsc_mgc_out_stdreg_d <= io_read_video_in_rsc_d_cse_sva_1;
              ball_x_out_rsc_mgc_out_stdreg_d <= ball_x_sva_dfm_6;
              ball_y_out_rsc_mgc_out_stdreg_d <= ball_y_sva_dfm_6;
              left_rsc_mgc_out_stdreg_d <= {1'b0 , left_miss_1_sva_dfm_4};
              right_rsc_mgc_out_stdreg_d <= {1'b0 , right_miss_1_sva_dfm_4};
            ...
            acc_10_sdt_1 = conv_s2s_30_15(conv_u2s_10_15(io_read_video_in_rsc_d_cse_sva[9:0])
            ...
            acc_psp_sg1_sva = readslicef_18_11_7((({(conv_u2u_10_11(io_read_video_in_rsc_d_cse_sva[29:20])
                + conv_s2u_9_11({1'b1 , (acc_10_sdt_1[14:7])})) , (acc_10_sdt_1[6:0])})
                + ({conv_u2u_34_17(conv_u2s_10_17(io_read_video_in_rsc_d_cse_sva[19:10])
            ...
            state_sva_dfm = MUX_v_3_2_2({3'b1 , state_sva}, asn_222_itm);
            ball_x_sva_dfm = MUX_v_10_2_2({10'b111100000 , ball_x_sva}, asn_222_itm);
            ball_y_sva_dfm = MUX_v_10_2_2({10'b11111010 , ball_y_sva}, asn_222_itm);
            ...
            state_sva_dfm_4 = MUX1HOT_v_3_5_2({3'b100 , 3'b1 , state_sva , 3'b11
                ...
                & nor_8_m1c) | ((~ asn_222_itm) & or_m1c)) , (asn_222_itm & or_m1c)
            ...
            mux_11_nl = MUX_v_8_2_2({8'b1111000 , (ball_x_sva[9:2])}, asn_222_itm
                & (~ slc_3_svs));
            ...
            and_29_cse = asn_222_itm & (~ slc_3_svs) & slc_4_svs;
            ...
            state_sva_dfm_15 = state_sva_dfm_7;
            slc_3_svs_1 = slc_3_svs;
            slc_4_svs_1 = slc_4_svs;
            ball_x_sva_dfm_7 = MUX_v_10_2_2({10'b111100000 , ball_x_sva}, and_29_cse);
            ball_y_sva_dfm_7 = MUX_v_10_2_2({10'b11111010 , ball_y_sva}, and_29_cse);
            left_miss_1_sva_dfm_4 = left_miss_1_sva_dfm_3;
            right_miss_1_sva_dfm_4 = right_miss_1_sva_dfm_3;
            ...
            if_25_slc_counter_itm_1 = counter_sva[18];
            if_25_slc_counter_1_itm_1 = counter_sva[15];
            if_25_slc_counter_2_itm_1 = counter_sva[14];
            if_25_slc_counter_3_itm_1 = counter_sva[11];
            if_25_slc_counter_4_itm_1 = counter_sva[8];
            if_25_nor_1_itm_1 = ~((counter_sva[19]) | (counter_sva[17]) | (counter_sva[16])
            ...
            slc_3_svs_st_1 = slc_3_svs;
            slc_4_svs_st_1 = slc_4_svs;
            main_stage_0_2 = 1'b1;
          end
        end
      end
    ...
    if_25_slc_counter_4_itm_1 = 1'b0;
    if_25_slc_counter_3_itm_1 = 1'b0;
    if_25_slc_counter_2_itm_1 = 1'b0;
    if_25_slc_counter_1_itm_1 = 1'b0;
    if_25_slc_counter_itm_1 = 1'b0;
    or_4_itm_1 = 1'b0;
    and_18_itm_1 = 1'b0;
    nor_12_itm_1 = 1'b0;
    asn_222_itm = 1'b0;
