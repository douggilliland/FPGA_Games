...
go compile
directive set /ball_update/core/main -DISTRIBUTED_PIPELINE true
directive set /ball_update/core/main -PIPELINE_INIT_INTERVAL 1
directive set /ball_update/right -STREAM 3
directive set /ball_update/left -STREAM 3
directive set /ball_update/ball_y_out -STREAM 10
directive set /ball_update/ball_x_out -STREAM 10
directive set /ball_update/video_out -STREAM 30
directive set /ball_update/vga_xy -STREAM 20
directive set /ball_update/video_in -STREAM 30
go architect
go extract
