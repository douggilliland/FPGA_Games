...
HD_PWD='C:/Users/asus/final changes/final changes.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Vgamain.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Vgamain.tcl -notrace
