...
HD_PWD='C:/Users/asus/final changes/final changes.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Vgamain.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Vgamain.tcl
