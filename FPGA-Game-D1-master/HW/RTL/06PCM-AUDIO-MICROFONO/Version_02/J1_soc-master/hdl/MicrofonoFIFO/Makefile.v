...
PINS 			= $(DESIGN).ucf
DEVICE			= XC7A100T-1CSG324 #XC3S500E-FG320-4(nexys2) XC6SLX16-CSG324C(nexys3) XC7A100T-1CSG324C(nexys4)
...
IVERILOG 		= iverilog
SRC 			= $(DESIGN).v fifo.v FIFO_MEM_BLK.v DivFreq.v FSM.v # Todos los archivos.v necesarios para el 
